...
typedef struct var_declarationAttri{
    std::map<std::string, typeAttrip> var_declarationAttrimap;
    std::string varout;
}var_declarationAttri,*var_declarationAttrip;
